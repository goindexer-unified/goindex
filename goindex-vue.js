self.props = {
  ...
  // https://github.com/goindexer-unified/goindex/tree/production/themes
...
(function () {
  ...
  async function onGet(request) {
    ...
    if (path.startsWith('/~_~_goindex/resources/')) {
      ...
      const r = await fetch(`https://raw.githubusercontent.com/goindexer-unified/goindex/production/themes/material-vue-${self.props.ui}/${remain}`);
